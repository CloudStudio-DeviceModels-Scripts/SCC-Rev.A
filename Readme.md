...
# Parsing + Configuration Script – SCC - Rev. A

This **Parsing + Configuration** script is designed for the **SCC** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – SCC Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **SCC** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
